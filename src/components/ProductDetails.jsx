            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-white space-y-6">
                        <div>
                            <h1 className="font-black text-3xl md:text-5xl font-mono text-white mb-4 tracking-wide uppercase">
                                {product.name}
                            </h1>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className={`border-none rounded-lg w-12 h-12 text-xl font-bold flex items-center justify-center font-mono ${product.inStock ? 'bg-main-purple text-white cursor-pointer hover:bg-purple-600 transition-colors duration-200' : 'bg-gray-700 text-gray-500 cursor-not-allowed'}`}
                                >
                                    -
                                </button>
                                <input
                                    ...
                                    className={`w-20 text-center text-lg border-2 rounded-lg py-3 px-2 font-mono focus:outline-none ${product.inStock ? 'border-main-purple bg-gray-800 text-white focus:border-purple-400' : 'border-gray-700 bg-gray-800 text-gray-500 cursor-not-allowed'}`}
                                />
                                <button
                                    disabled={!product.inStock}
                        ...
                        {product.inStock ? (
                            <button
                                className="w-full md:w-auto bg-main-purple text-blue-50 hover:text-black border-none rounded-2xl py-4 px-9 text-xl font-bold cursor-pointer transition-all duration-200 hover:bg-white hover:transform hover:scale-100 font-mono tracking-wider uppercase shadow-lg"
                            ...
                            <button
                                disabled
                                className="w-full md:w-auto bg-gray-700 text-gray-400 border-none rounded-2xl py-4 px-9 text-xl font-bold cursor-not-allowed font-mono tracking-wider uppercase shadow-lg"
                            >
                                OUT OF STOCK
                            </button>
                        )}
